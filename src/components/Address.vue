...
<div class="container table-div" style="padding: 2rem;background: white;">
        ...
        <tbody>
            <tr>
              ...
              <td>vite_67ed131aaff44f8832fc5ce9562742ae467571c947395eb8ac</td>
            </tr>
            <tr>
...
<div class="tabs is-medium" style="background-color: #fff;margin-bottom: 0rem;">
  <ul>
    <li><a>Token Balance</a></li>
    <li class="is-active"><a href="#">Transactions</a></li>
